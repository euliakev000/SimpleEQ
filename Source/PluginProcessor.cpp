...
void SimpleEQAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    auto chainSettings = getChainSettings(avpts);
...
ChainSettings getChainSettings(juce::AudioProcessorValueTreeState& avpts)
{
    ...
    settings.peakQ = avpts.getRawParameterValue("Peak Q")->load();
    settings.lowCutSlope = static_cast<Slope>(avpts.getRawParameterValue("LowCut Slope")->load());
    settings.highCutSlope = static_cast<Slope>(avpts.getRawParameterValue("HighCut Slope")->load());
...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID("Peak Q", 1),
                                                           "Peak Q",
